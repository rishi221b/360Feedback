...
using InitialTry.Api.Middleware;
using InitialTry.Application;
using InitialTry.Application.Contracts;
using InitialTry.Infrastructure;
using InitialTry.Persistence;
using InitialTry.Identity;
using InitialTry.Api.Services;
using InitialTry.Api.Extensions;
using Microsoft.Extensions.Options;
using Swashbuckle.AspNetCore.SwaggerGen;
using InitialTry.Api.SwaggerHelper;
