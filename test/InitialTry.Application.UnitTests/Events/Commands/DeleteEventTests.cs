...
using InitialTry.Application.Features.Events.Commands.DeleteEvent;
using InitialTry.Application.UnitTests.Mocks;
...
namespace InitialTry.Application.UnitTests.Events.Commands
{
